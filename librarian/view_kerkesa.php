...
<?php include('navbar_books.php'); ?>
	...
	<br> <br><br>
	 <div class="alert alert-info">
                                    ...
                                    <strong><i class="icon-user icon-large"></i>&nbsp;Shiko Te Gjithe Kekesat</strong>
                                </div>
	
<table border="1" align="center" width="700"cellpadding="0" cellspacing="0" border="0" class="table  table-bordered" id="example">
    ...
    <tr align="center" >
		...
		<?php
		include('dbcon.php');
		$run_kerkesa= mysql_query("select * from kerkesa");
		$i=0;
